...
**Plans:**
- [ ] 05-01-PLAN.md — 成本收益账单表、固定点金额 helper 和账单写入基础
- [ ] 05-02-PLAN.md — 端点成本价与全局售价配置 API
- [ ] 05-03-PLAN.md — 生成成功路径记账与端点归属传递
- [ ] 05-04-PLAN.md — 成本收益聚合查询与管理统计 API
- [ ] 05-05-PLAN.md — adminApi 定价与统计客户端类型
